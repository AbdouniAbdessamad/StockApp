                                        ...
                                        <table class="min-w-full divide-y divide-gray-300">
                                            ...
                                            <tbody class="divide-y divide-gray-200 bg-white">
                                                @foreach ($articles as $article)
                                                    ...
                                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-900 sm:pl-6">{{ $article->bon_commande }}</td>
                                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-900 sm:pl-6">{{ $article->supplier_id }}</td>
                                                    <td class="whitespace-nowrap py-4 pl-4 pr-3 text-lg font-medium text-gray-900 sm:pl-6">{{ $article->name }}</td>
                                                    <td class="whitespace-nowrap px-3 py-4 text-lg  text-gray-900 sm:pl-6">{{ $article->ref }}</td>
                                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-900 sm:pl-6">{{ $article->quantity }}</td>
                                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-900 sm:pl-6">{{ $article->category_id }}</td>
                                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-900 sm:pl-6">{{ $article->status }}</td>
                                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-900 sm:pl-6">{{ $article->last_editor_id }}</td>
